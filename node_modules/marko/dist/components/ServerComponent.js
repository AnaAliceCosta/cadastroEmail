...
class ServerComponent {
    constructor(id, input, out, typeName, customEvents, scope) {
        this.id = id;
        this.l_ = customEvents;
        this.e_ = scope;
        this._C_ = undefined;
        this.n_ = undefined;
        this.g_ = undefined;
        this.typeName = typeName;
        this.k_ = undefined; // Used to keep track of bubbling DOM events for components rendered on the server
        this._D_ = 0;
        ...
        if (this.onInput !== undefined) {
            ...
            if (this.n_ === undefined) {
                this.n_ = updatedInput;
            }

            this._C_ = updatedInput;
        } else {
            this.n_ = this._C_ = input;
        }
