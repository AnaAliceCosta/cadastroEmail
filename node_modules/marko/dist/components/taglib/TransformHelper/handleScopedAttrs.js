...
module.exports = function handleComponentKeyAttrs() {
    ...
    attrs.forEach(attribute => {
        ...
        if (attributeName !== scopedSuffix && attributeName.endsWith(scopedSuffix)) {
            const finalAttributeName = attributeName.slice(0, 0 - scopedSuffix.length);
            ...
            el.setAttributeValue(finalAttributeName, this.buildComponentElIdFunctionCall(attribute.value));
        }
    });
};