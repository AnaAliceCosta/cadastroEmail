module.exports = function nodeFactory(elNode, context) {
    ...
    if (!defAttr || defAttr.name !== "name" || !defAttr.value || typeof defAttr.value.value !== "string") {
        context.addError(elNode, 'The <macro> tag must only contain a "name" attribute, example: <macro|data| name="my-macro">');
        return elNode;
    }
