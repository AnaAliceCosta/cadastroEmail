...
module.exports = function migrate(el, context) {
    el.forEachAttribute(attr => {
        ...
        if (findBoundParent(el)) {
            ...
            context.deprecate(`Using "w-on*" in a template without a "w-bind" is deprecated. The "w-on*" attributes are also deprecated. Please use "on*()" instead. See: https://github.com/marko-js/marko/wiki/Deprecation:-w-*-Atrributes`);
