...
module.exports = function migrate(el, context) {
    el.forEachAttribute(attr => {
        ...
        context.deprecate(`The "${name}" attribute is deprecated. Please use "${newAttrName}" attribute instead. See: https://github.com/marko-js/marko/wiki/Deprecation:-w-*-Atrributes`);
