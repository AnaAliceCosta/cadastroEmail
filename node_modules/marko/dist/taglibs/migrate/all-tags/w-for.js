    ...
    if (el.hasAttribute("w-for") || el.hasAttribute("for-key") || el.hasAttribute("for-ref")) {
        el.forEachAttribute(attr => {
            ...
            if (name === "w-for" && !findBoundParent(el)) {
                context.deprecate(`Using "w-for" in a template without a "w-bind" is deprecated. The "${name}" attribute is also deprecated. Please use "for:scoped" instead. See: https://github.com/marko-js/marko/wiki/Deprecation:-w-*-Atrributes`);
                context.setMigrationFlag("legacyWidgetAttrsWithoutBind");
            } else {
                context.deprecate(`The "${name}" attribute is deprecated. Please use "for:scoped" instead. See: https://github.com/marko-js/marko/wiki/Deprecation:-w-*-Atrributes`);
            }
