module.exports = function migrate(el, context) {
    ...
    const hasParamsFlag = tagDef && tagDef.featureFlags && tagDef.featureFlags.includes("params");
...
function enableTagParams(el, context) {
    if (el.argument) {
        context.deprecate(`The <${el.tagName}(param)> syntax is deprecated. Please use the <${el.tagName}|param|> syntax instead. See: https://github.com/marko-js/marko/wiki/Deprecation:-paren-params`, el);
