...
module.exports = function migrator(elNode, context) {
    ...
    if (!context.util.isValidJavaScriptIdentifier(varName)) {
        context.addError('Invalid <async-fragment> tag. Argument\'s variable name should be a valid JavaScript identifier. Example: user, as in <async-fragment data-provider=data.userInfo var="userInfo" />');
        return;
    }
