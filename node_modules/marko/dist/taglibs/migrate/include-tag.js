...
module.exports = function migrator(elNode, context) {
    ...
    if (target.type === "Literal") {
        ...
        const isMemberOrIdentifer = target.type === "MemberExpression" || target.type === "Identifier";
        let finalTarget = target;

        if (!isMemberOrIdentifer) {
            const complexIncludeIdentifierCount = context._complexIncludeIdentifierCount = (context._complexIncludeIdentifierCount || 0) + 1;
        ...
        elNode.insertSiblingBefore(builder.htmlElement("if", undefined, [builder.text(finalTarget)], printJS(builder.binaryExpression(builder.unaryExpression(finalTarget, "typeof", true), "===", builder.literal("string")), context)));
