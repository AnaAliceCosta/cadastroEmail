...
module.exports = function render(elNode, context) {
    ...
    context.deprecate("The <layout-use> tag is deprecated. Please use a combination of the <${dynamic}> tag and imports instead. See: https://github.com/marko-js/marko/wiki/Deprecation:-layout-tags");
    ...
    dynamicTag.rawTagNameExpression = target.type === "Literal" ? importTag(target.value, context) : printJS(target, context);
